...
WebUI.verifyElementPresent(findTestObject('employment_management/division/breadcrumb_create'), 0)

WebUI.click(findTestObject('employment_management/division/breadcrumb_create'), FailureHandling.STOP_ON_FAILURE)
