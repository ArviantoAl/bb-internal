...
WebUI.setText(findTestObject('job_title/formSearchJobTitle'), 'John')

Thread.sleep(2000)

WebUI.verifyElementPresent(findTestObject('employment_management/division/john_doe_found'), 0)
