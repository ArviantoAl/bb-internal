...
WebUI.click(findTestObject('employment_management/division/delete_button'))

WebUI.verifyElementPresent(findTestObject('employment_management/division/success_delete'), 0)
