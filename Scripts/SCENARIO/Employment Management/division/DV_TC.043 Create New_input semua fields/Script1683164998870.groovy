...
WebUI.setText(findTestObject('employment_management/division/name_division'), 'Automation '+ code)

WebUI.setText(findTestObject('employment_management/division/code_division'), 'CODE '+ code)

WebUI.click(findTestObject('employment_management/division/select_parent'))

WebUI.click(findTestObject('employment_management/division/select_content'))

WebUI.click(findTestObject('employment_management/division/select_manager'))
