...
WebUI.click(findTestObject('employment_management/division/manager_asc'))

WebUI.verifyElementPresent(findTestObject('employment_management/division/manager_desc'), 0)

WebUI.click(findTestObject('employment_management/division/manager_desc'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('employment_management/division/manager_asc'), 0)
