...
WebUI.setText(findTestObject('job_title/formSearchJobTitle'), 'Manager Division Telah dihapus')

Thread.sleep(2000)

WebUI.verifyElementPresent(findTestObject('employment_management/division/no_division_found'), 0)
