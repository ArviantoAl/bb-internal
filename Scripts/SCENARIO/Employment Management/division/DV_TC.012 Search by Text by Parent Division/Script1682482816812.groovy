...
WebUI.setText(findTestObject('job_title/formSearchJobTitle'), 'Content Creator')

Thread.sleep(2000)

WebUI.verifyElementPresent(findTestObject('employment_management/division/conten_creator_found'), 0)
