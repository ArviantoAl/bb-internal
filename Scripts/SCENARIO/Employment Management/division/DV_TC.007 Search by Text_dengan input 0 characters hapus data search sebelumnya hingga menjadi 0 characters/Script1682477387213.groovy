...
WebUI.sendKeys(findTestObject('job_title/formSearchJobTitle'), Keys.chord(Keys.COMMAND, 'a'))

WebUI.sendKeys(findTestObject('job_title/formSearchJobTitle'), Keys.chord(Keys.BACK_SPACE))

WebUI.verifyElementPresent(findTestObject('employment_management/division/table_value_appears'), 0)
