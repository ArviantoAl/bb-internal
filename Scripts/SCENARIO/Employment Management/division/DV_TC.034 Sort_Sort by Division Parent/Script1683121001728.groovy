...
WebUI.click(findTestObject('employment_management/division/parent_asc'))

WebUI.verifyElementPresent(findTestObject('employment_management/division/parent_desc'), 0)

WebUI.click(findTestObject('employment_management/division/parent_desc'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('employment_management/division/parent_asc'), 0)
