...
WebUI.setText(findTestObject('employment_management/job_title/job_title_name_form'), ' ')

WebUI.verifyElementPresent(findTestObject('employment_management/job_title/alert_space_not_allowed'), 0)
