...
WebUI.click(findTestObject('employment_management/job_title/toggle_status'))

WebUI.verifyElementPresent(findTestObject('job_title/stateInactiveData'), 0)

WebUI.click(findTestObject('employment_management/job_title/toggle_status'))

WebUI.verifyElementPresent(findTestObject('job_title/stateActiveData'), 0)
