...
WebUI.verifyElementPresent(findTestObject('employment_management/job_title/name_asc'), 0)

WebUI.click(findTestObject('employment_management/job_title/name_asc'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('employment_management/job_title/name_desc'), 0)
