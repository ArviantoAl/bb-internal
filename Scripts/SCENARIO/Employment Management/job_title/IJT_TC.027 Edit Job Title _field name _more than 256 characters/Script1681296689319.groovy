...
WebUI.setText(findTestObject('employment_management/job_title/job_title_name_form'), code)

String value = WebUI.getAttribute(findTestObject('employment_management/job_title/job_title_name_form'), 'value')
