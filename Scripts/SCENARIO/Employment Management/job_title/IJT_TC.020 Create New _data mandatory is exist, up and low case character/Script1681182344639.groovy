...
WebUI.setText(findTestObject('employment_management/job_title/job_title_name_form'), 'Script Automation')

WebUI.setText(findTestObject('employment_management/job_title/job_title_code_form'), '6666')

WebUI.verifyElementPresent(findTestObject('employment_management/job_title/code_exist'), 0)

WebUI.verifyElementPresent(findTestObject('employment_management/job_title/name_exist'), 0)
