...
WebUI.setText(findTestObject('Object Repository/master_employee/input_Job Title_form-control'), 'Saepuloh')

WebUI.verifyElementVisible(findTestObject('master_employee/td_name'))
