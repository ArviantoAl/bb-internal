...
WebUI.scrollToElement(findTestObject('master_employee/nextPage'), 0)

WebUI.click(findTestObject('master_employee/nextPage'))

WebUI.verifyElementVisible(findTestObject('master_employee/pageAlreadyMove'))
