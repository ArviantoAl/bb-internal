...
WebUI.setText(findTestObject('master_employee/inputEmail'), Keys.chord(Keys.COMMAND, 'a'))

WebUI.setText(findTestObject('master_employee/inputEmail'), Keys.chord(Keys.BACK_SPACE))

WebUI.setText(findTestObject('master_employee/inputEmail'), 'automation@mail.com')
