...
WebUI.click(findTestObject('master_employee/chooseJobtitle'))

WebUI.click(findTestObject('master_employee/filterAutomation'))

WebUI.click(findTestObject('master_employee/toggleBtn'))

WebUI.verifyElementVisible(findTestObject('master_employee/stateInactiveData'))

WebUI.click(findTestObject('master_employee/toggleBtn'))

WebUI.verifyElementVisible(findTestObject('master_employee/stateActiveData'))
