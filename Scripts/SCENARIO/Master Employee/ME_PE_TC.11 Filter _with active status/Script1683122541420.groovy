...
WebUI.click(findTestObject('master_employee/filterStatus'))

WebUI.click(findTestObject('master_employee/statusActive'))

WebUI.verifyElementVisible(findTestObject('job_title/stateActiveData'))
