...
WebUI.setText(findTestObject('Object Repository/master_employee/input_Job Title_form-control'), 'saepuloh@monstercode.net')

WebUI.verifyElementVisible(findTestObject('master_employee/td_email'))
