...
assert WebUI.verifyElementText(findTestObject('Object Repository/master data management/Languages/language_alpha_3_code-error'), 'Language Alpha 3 Code must be at least 3 characters')
