...
WebUI.verifyElementAttributeValue(findTestObject('Object Repository/master data management/Languages/tableHeader_Flag'), 'class', 'min-tablet-p sorting_disabled', 0)
