...
WebUI.setText(findTestObject('Object Repository/master data management/Languages/input_Language Name_language_name'), 'indonesia')

assert WebUI.verifyElementText(findTestObject('Object Repository/master data management/Languages/language_name-error'), 'Language Name already exists')
