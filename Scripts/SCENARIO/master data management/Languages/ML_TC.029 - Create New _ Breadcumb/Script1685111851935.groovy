...
WebUI.click(findTestObject('Object Repository/master data management/Languages/breadcrumb', [('breadcrumb') :'Master Data Management']))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/master data management/Languages/breadcrumb', [('breadcrumb') :'Create Language']))
