...
WebUI.mouseOver(findTestObject('Object Repository/master data management/Languages/btn_View'))

WebUI.verifyTextPresent('Edit Language', false)

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/master data management/Languages/tooltip'), 'data-original-title', 'Click to view details', 0)
