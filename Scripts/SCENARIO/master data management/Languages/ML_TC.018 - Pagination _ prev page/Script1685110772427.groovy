...
WebUI.click(findTestObject('Object Repository/master data management/Languages/pagination_next'))

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/master data management/Languages/pagination_prev'))
