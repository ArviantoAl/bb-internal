...
WebUI.setText(findTestObject('Object Repository/master data management/Languages/input_Language Alpha 3 Code_language_alpha_3_code'), 'ab5')

WebUI.takeFullPageScreenshot()

WebUI.setText(findTestObject('Object Repository/master data management/Languages/input_Language Alpha 3 Code_language_alpha_3_code'), '%&')
