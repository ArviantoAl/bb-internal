...
def language_name_fr = RandomStringUtils.randomAlphanumeric(300)
...
def value = WebUI.getAttribute(findTestObject('Object Repository/master data management/Languages/input_Language Name_language_name_fr'), 'value')
