...
def language_alpha_3_code = RandomStringUtils.randomAlphanumeric(10)

WebUI.setText(findTestObject('Object Repository/master data management/Languages/input_Language Alpha 3 Code_language_alpha_3_code'), language_alpha_3_code)

def value = WebUI.getAttribute(findTestObject('Object Repository/master data management/Languages/input_Language Alpha 3 Code_language_alpha_3_code'), 'value')
