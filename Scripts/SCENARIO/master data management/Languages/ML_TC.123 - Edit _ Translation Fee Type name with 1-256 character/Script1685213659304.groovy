...
def language_name_fr = RandomStringUtils.randomAlphanumeric(256)

WebUI.setText(findTestObject('Object Repository/master data management/Languages/input_Language Name_language_name_fr'), language_name_fr)

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/master data management/Languages/input_Language Name_language_name'), 'maxlength', '256', 0)
