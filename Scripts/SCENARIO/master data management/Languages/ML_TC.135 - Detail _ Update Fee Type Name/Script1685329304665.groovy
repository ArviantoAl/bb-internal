...
WebUI.verifyElementNotClickable(findTestObject('Object Repository/master data management/Languages/input_Language Name_language_name'))

WebUI.verifyElementHasAttribute(findTestObject('Object Repository/master data management/Languages/input_Language Name_language_name'), 'disabled', 0)