...
WebUI.setText(findTestObject('Object Repository/master data management/Languages/input_Language Code_language_code'), 'id')

assert WebUI.verifyElementText(findTestObject('Object Repository/master data management/Languages/language_code-error'), 'Code already exists')
