...
WebUI.setText(findTestObject('Object Repository/master data management/Languages/input_Search'), randomChar)

def value = WebUI.getAttribute(findTestObject('Object Repository/master data management/Languages/input_Search'), 'value')
