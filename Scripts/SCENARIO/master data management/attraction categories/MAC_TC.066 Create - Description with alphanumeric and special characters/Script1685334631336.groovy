...
WebUI.setText(findTestObject('master data management/attraction categories/form_name'),'Test Automation description alphanumeric')

WebUI.setText(findTestObject('master data management/attraction categories/form_description'), keyword)
