...
WebUI.mouseOver(findTestObject('master_employee/create_new_button'))

WebUI.click(findTestObject('master_employee/create_new_button'))

WebUI.verifyElementPresent(findTestObject('master data management/attraction categories/header_create'), 0)

WebUI.verifyElementPresent(findTestObject('master data management/attraction categories/breadcrumb_create'), 0)

WebUI.click(findTestObject('master data management/attraction categories/breadcrumb_create'), FailureHandling.STOP_ON_FAILURE)
