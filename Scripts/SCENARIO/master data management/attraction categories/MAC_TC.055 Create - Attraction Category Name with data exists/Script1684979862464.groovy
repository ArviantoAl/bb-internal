...
WebUI.setText(findTestObject('master data management/attraction categories/form_name'), 'Automation Katalon')

WebUI.verifyElementPresent(findTestObject('master data management/attraction categories/name_exist'), 0)
