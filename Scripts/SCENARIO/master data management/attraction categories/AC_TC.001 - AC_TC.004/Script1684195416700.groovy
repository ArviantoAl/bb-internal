...
WebUI.verifyElementPresent(findTestObject('master data management/attraction categories/header_dashboard'), 0)

WebUI.verifyElementPresent(findTestObject('job_title/formSearchJobTitle'), 0)
