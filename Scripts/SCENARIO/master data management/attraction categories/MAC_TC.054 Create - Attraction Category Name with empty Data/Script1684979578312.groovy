...
String keyword = randomString(chars, 10)
...
WebUI.setText(findTestObject('master data management/attraction categories/form_name'), keyword)

WebUI.sendKeys(findTestObject('master data management/attraction categories/form_name'), Keys.chord(Keys.COMMAND, 'a'))

WebUI.sendKeys(findTestObject('master data management/attraction categories/form_name'), Keys.chord(Keys.BACK_SPACE))

WebUI.verifyElementPresent(findTestObject('master data management/attraction categories/name_required'), 0)
