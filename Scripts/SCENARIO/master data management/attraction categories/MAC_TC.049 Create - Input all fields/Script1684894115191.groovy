...
WebUI.setText(findTestObject('master data management/attraction categories/form_name'), 'Test Script Automation ' + keyword)

WebUI.setText(findTestObject('master data management/attraction categories/form_description'), 'Test Script Desxcription')
...
WebUI.setText(findTestObject('master data management/attraction categories/form_translation'), 'Translation Name')

WebUI.setText(findTestObject('master data management/attraction categories/form_desc_trans'), 'Translation Name Description')
