...
WebUI.mouseOver(findTestObject('employment_management/job_title/delete_button'))

WebUI.click(findTestObject('employment_management/job_title/delete_button'))

WebUI.verifyElementPresent(findTestObject('master data management/attraction categories/confirm_delete_message'), 0)
