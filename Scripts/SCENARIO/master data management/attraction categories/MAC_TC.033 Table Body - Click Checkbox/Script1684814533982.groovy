...
WebUI.verifyElementPresent(findTestObject('master data management/attraction categories/remove_attraction_categories'), 
    0)

WebUI.verifyElementPresent(findTestObject('master data management/attraction categories/update_status'), 0)
