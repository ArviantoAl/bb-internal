...
WebUI.click(findTestObject('master data management/attraction categories/table_name'))

WebUI.verifyElementPresent(findTestObject('master data management/attraction categories/name_desc'), 0)

WebUI.click(findTestObject('master data management/attraction categories/table_name'))

WebUI.verifyElementPresent(findTestObject('master data management/attraction categories/name_asc'), 0)
