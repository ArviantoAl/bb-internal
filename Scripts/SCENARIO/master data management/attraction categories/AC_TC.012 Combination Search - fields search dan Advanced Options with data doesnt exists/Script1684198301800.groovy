...
String keyword = randomString(chars, 300)
...
WebUI.setText(findTestObject('corporate_airline_fare/formSearchAirlineFareData'), 'No data exist')
...
WebUI.click(findTestObject('user_management/choose_active'), FailureHandling.STOP_ON_FAILURE)

Thread.sleep(2000)

WebUI.verifyElementPresent(findTestObject('user_management/active_found'), 0)
