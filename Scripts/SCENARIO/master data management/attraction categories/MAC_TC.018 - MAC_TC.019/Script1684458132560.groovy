...
WebUI.setText(findTestObject('corporate_airline_fare/formSearchAirlineFareData'), 'Theme')

Thread.sleep(2000)

WebUI.click(findTestObject('master data management/attraction categories/checkbox_bulk'))

WebUI.click(findTestObject('master data management/attraction categories/update_status'))

WebUI.click(findTestObject('master data management/attraction categories/status_active'))
...
WebUI.click(findTestObject('master data management/attraction categories/status_inactive'))
