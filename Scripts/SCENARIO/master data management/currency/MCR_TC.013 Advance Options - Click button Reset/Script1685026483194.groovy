...
WebUI.click(findTestObject('master data management/currency/reset_btn'))

WebUI.verifyElementNotVisible(findTestObject('master data management/currency/dd_status'))
