...
WebUI.verifyElementPresent(findTestObject('master data management/currency/arrow_up'), 0)

WebUI.verifyElementPresent(findTestObject('master data management/currency/dd_status'), 0)
