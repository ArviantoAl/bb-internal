...
selectorType.addProperty('xpath', ConditionType.EQUALS, "//input[@id='cb-th']")

WebUI.click(selectorType)

WebUI.verifyElementPresent(findTestObject('master data management/currency/update_status_dd'), 0)

WebUI.verifyElementPresent(findTestObject('master data management/currency/remove_currency_btn'), 0)
