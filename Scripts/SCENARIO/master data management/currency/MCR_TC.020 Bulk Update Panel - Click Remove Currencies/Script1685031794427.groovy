...
WebUI.click(findTestObject('master data management/currency/remove_currency_btn'))

WebUI.verifyElementText(findTestObject('master data management/currency/modal_body'), 'Are you sure you want to delete this?')

WebUI.verifyElementPresent(findTestObject('master data management/currency/delete_btn'), 0)

WebUI.verifyElementPresent(findTestObject('master data management/currency/cancel_btn'), 0)
