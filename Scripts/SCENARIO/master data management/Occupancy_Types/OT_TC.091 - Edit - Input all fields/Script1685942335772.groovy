...
WebUI.setText(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Occupancy Types/field_search'), 'tesupdate')
...
WebUI.click(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Create Occupancy Type/field_Is default_yes'))

WebUI.click(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Edit Occupancy Type/Edit_SAVE'))
