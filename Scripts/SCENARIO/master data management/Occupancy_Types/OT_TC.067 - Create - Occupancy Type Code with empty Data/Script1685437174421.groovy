...
WebUI.verifyElementPresent(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Create Occupancy Type/alert_Occupancy Type Code is required'), 
    0)
