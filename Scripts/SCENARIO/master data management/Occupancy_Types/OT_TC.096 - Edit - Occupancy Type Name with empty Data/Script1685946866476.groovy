...
WebUI.sendKeys(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Edit Occupancy Type/Edit_field occ type name'), 
...
WebUI.verifyElementPresent(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Edit Occupancy Type/Edit_alert_Occupancy Type Name is required'), 
    0)
