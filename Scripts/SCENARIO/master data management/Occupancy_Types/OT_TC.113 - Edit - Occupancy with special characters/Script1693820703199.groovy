...
WebUI.setText(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Edit Occupancy Type/Edit_field occ type name'), 
    'updateforoccupancyWITHSPECIALCHAR')
...
WebUI.verifyElementText(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Edit Occupancy Type/Edit_alert_OccPlease enter a valid number'), 
    '')
