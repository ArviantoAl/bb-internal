...
WebUI.setText(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Edit Occupancy Type/Edit_field occ type name'), 
    'updateforoccupancy1num')

WebUI.sendKeys(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Edit Occupancy Type/Edit_field Occupancy'), 
...
WebUI.verifyElementPresent(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Edit Occupancy Type/Edit_alert_Occupancy is required'), 
    0)
