...
WebUI.verifyElementText(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Create Occupancy Type/translation_danger kosong'), 
    '')

WebUI.verifyElementText(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Create Occupancy Type/translation_note'), 
    '')

WebUI.verifyElementText(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Create Occupancy Type/translation_text note danger'), 
    '')
