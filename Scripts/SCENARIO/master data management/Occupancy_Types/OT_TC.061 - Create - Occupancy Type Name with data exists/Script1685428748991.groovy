...
WebUI.verifyElementPresent(findTestObject('master data management/Occupancy_Types/Page_Bayu Buana - Create Occupancy Type/alret_Occupancy Type Name already exists'), 
    0)
