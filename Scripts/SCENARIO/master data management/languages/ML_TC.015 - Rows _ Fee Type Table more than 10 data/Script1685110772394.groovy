...
WebUI.selectOptionByLabel(findTestObject('Object Repository/master data management/languages/dataTables_length'), 'All', false)

TestObject tableObject = findTestObject('Object Repository/master data management/languages/table')
