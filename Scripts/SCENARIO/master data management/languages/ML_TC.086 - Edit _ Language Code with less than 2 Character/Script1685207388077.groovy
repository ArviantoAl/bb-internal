...
WebUI.setText(findTestObject('Object Repository/master data management/languages/input_Language Code_language_code'), '1')

assert WebUI.verifyElementText(findTestObject('Object Repository/master data management/languages/language_code-error'), 'Language Code must be at least 2 characters')
