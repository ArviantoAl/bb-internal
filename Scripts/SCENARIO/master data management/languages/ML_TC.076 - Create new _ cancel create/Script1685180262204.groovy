...
WebUI.scrollToElement(findTestObject('Object Repository/master data management/languages/btn_Cancel'), 0)

WebUI.click(findTestObject('Object Repository/master data management/languages/btn_Cancel'))
