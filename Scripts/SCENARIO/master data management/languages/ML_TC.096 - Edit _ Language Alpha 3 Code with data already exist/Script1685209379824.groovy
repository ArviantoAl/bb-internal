...
WebUI.setText(findTestObject('Object Repository/master data management/languages/input_Language Code_language_code'), 'idn')

WebUI.verifyElementText(findTestObject('Object Repository/master data management/languages/language_alpha_3_code-error'), 'data already exist')
