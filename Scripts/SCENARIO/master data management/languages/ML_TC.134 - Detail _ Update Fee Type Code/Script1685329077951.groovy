...
WebUI.verifyElementNotClickable(findTestObject('Object Repository/master data management/languages/input_Language Code_language_code'))

WebUI.verifyElementHasAttribute(findTestObject('Object Repository/master data management/languages/input_Language Code_language_code'), 'disabled', 0)
