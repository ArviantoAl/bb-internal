...
def language_code = RandomStringUtils.randomAlphanumeric(10)

WebUI.setText(findTestObject('Object Repository/master data management/languages/input_Language Code_language_code'), language_code)

def value = WebUI.getAttribute(findTestObject('Object Repository/master data management/languages/input_Language Code_language_code'), 'value')
