...
def language_native_name_fr = RandomStringUtils.randomAlphanumeric(300)

WebUI.setText(findTestObject('Object Repository/master data management/languages/input_Language Native Name_language_native_name_fr'), language_native_name_fr)

def value = WebUI.getAttribute(findTestObject('Object Repository/master data management/languages/input_Language Native Name_language_native_name_fr'), 'value')
