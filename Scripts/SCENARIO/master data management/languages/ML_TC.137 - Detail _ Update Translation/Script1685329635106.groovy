...
WebUI.verifyElementNotClickable(findTestObject('Object Repository/master data management/languages/input_Language Native Name_language_native_name_fr'))

WebUI.verifyElementHasAttribute(findTestObject('Object Repository/master data management/languages/input_Language Native Name_language_native_name_fr'), 'disabled', 0)