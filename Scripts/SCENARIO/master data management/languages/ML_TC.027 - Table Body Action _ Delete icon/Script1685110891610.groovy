...
WebUI.mouseOver(findTestObject('Object Repository/master data management/languages/btn_Delete'))

WebUI.verifyTextPresent('Click to delete', false)

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/master data management/languages/btn_Delete'))

WebUI.verifyTextPresent('Are you sure you want to delete this?', false)
