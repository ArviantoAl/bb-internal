...
//WebUI.callTestCase(findTestCase('Test Cases/SCENARIO/master data management/zones/create new'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/master data management/languages/input_Search'), GlobalVariable.zoneCode)

WebUI.verifyTextPresent(GlobalVariable.zoneCode, false)
