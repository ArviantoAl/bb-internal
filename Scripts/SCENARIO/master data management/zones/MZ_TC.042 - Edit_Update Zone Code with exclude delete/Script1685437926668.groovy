...
WebUI.callTestCase(findTestCase('SCENARIO/master data management/zones/MZ_TC.022 - Create New_Input All Fields'), [:], FailureHandling.STOP_ON_FAILURE)
...
def randomZoneName = RandomStringUtils.randomAlphabetic(5)
...
WebUI.click(findTestObject('Object Repository/master data management/zones/option_Destination', [('destination') : 'Batam']))

WebUI.setText(findTestObject('Object Repository/master data management/zones/input_Zone Code'), GlobalVariable.zoneCode )

def valueZoneCode = WebUI.getAttribute(findTestObject('Object Repository/master data management/zones/input_Zone Code'), 'value')

WebUI.verifyElementNotPresent(findTestObject('Object Repository/master data management/zones/error_Zone Code'), 0)
