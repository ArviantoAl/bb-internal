...
WebUI.setText(findTestObject('Object Repository/master data management/zones/input_Search'), GlobalVariable.zoneName)
WebUI.verifyTextPresent('No zones found', false)
WebUI.takeFullPageScreenshot()
...
WebUI.click(findTestObject('Object Repository/master data management/zones/option_Destination', [('destination') : 'Padang']))
...
def expectedText = 'Record ' +valueZoneCode+' - '+valueZoneName+ ' has been successfully saved.'
