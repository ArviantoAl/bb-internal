...
value = WebUI.getAttribute(findTestObject('Object Repository/master data management/zones/error_Zone Name'), 'value')
...
WebUI.setText(findTestObject('Object Repository/master data management/zones/input_Zone Name'), value)
