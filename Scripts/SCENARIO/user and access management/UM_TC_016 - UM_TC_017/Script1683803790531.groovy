...
WebUI.click(findTestObject('user_management/toggle'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('user_management/status_active_inactive'), 0)
