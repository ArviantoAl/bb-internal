...
WebUI.verifyElementPresent(findTestObject('user_management/adv_jt'), 0)

WebUI.verifyElementPresent(findTestObject('user_management/adv_ll'), 0)

WebUI.verifyElementPresent(findTestObject('user_management/adv_status'), 0)

WebUI.verifyElementPresent(findTestObject('user_management/adv_ut'), 0)
