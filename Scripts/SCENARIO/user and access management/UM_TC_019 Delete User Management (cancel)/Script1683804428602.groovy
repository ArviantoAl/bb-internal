...
WebUI.click(findTestObject('special_dates/btn_delete'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('user_management/pop_up_delete'), 0)

WebUI.click(findTestObject('user_management/Delete_button_popUp'), FailureHandling.STOP_ON_FAILURE)
