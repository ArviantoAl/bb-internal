...
WebUI.click(findTestObject('user_management/choose_ut'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('user_management/choose_ut'), 'Corporate Register')

Thread.sleep(2000)

WebUI.click(findTestObject('user_management/ceklis_ao'), FailureHandling.STOP_ON_FAILURE)

Thread.sleep(2000)

WebUI.verifyElementPresent(findTestObject('user_management/cr_found'), 0)
