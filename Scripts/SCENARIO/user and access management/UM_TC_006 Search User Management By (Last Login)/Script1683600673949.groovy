...
WebUI.click(findTestObject('user_management/input_date'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('user_management/date_now'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('user_management/breadcrumb_board'), FailureHandling.STOP_ON_FAILURE)

Thread.sleep(2000)

WebUI.verifyElementPresent(findTestObject('user_management/data_appears'), 0)
