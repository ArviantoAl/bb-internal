...
WebUI.verifyElementPresent(findTestObject('corporate_airline_fare/formSearchAirlineFareData'), 0)

WebUI.verifyElementAttributeValue(findTestObject('corporate_airline_fare/formSearchAirlineFareData'), 'placeholder', 'Search...', 0)

WebUI.verifyElementAttributeValue(findTestObject('corporate_airline_fare/formSearchAirlineFareData'), 'value', '', 0)
