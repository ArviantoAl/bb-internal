...
WebUI.verifyElementPresent(findTestObject('corporate_airline_fare/breadcrumb'), 0)

WebUI.verifyElementText(findTestObject('division/breadcrumb_li1'), 'Setup & Configuration')

WebUI.verifyElementText(findTestObject('division/breadcrumb_li2'), 'Division')

WebUI.verifyElementText(findTestObject('division/breadcrumb_li3'), 'Create Division')
