...
WebUI.setText(findTestObject('employment_management/division/search_parent_manager'), 'data kosong')

WebUI.verifyElementPresent(findTestObject('employment_management/division/no_result_found'), 0)
