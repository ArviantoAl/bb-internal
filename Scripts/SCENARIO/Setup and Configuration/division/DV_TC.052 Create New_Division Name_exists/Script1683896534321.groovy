...
WebUI.setText(findTestObject('employment_management/division/name_division'), 'Data Exist')

WebUI.click(findTestObject('employment_management/division/SAVE_button'))

WebUI.verifyElementPresent(findTestObject('employment_management/division/name_exist'), 0)
