...
WebUI.click(findTestObject('division/breadcrumb_li1'), 'Setup & Configuration')

WebUI.click(findTestObject('division/breadcrumb_li3'), 'Create Division')

WebUI.click(findTestObject('division/breadcrumb_li2'), 'Division')
