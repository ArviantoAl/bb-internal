...
String str = WebUI.getText(findTestObject('division/update_status_ai'))

WebUI.mouseOver(findTestObject('division/update_status_ai'))

WebUI.verifyTextPresent(str, false)
