...
WebUI.click(findTestObject('Object Repository/special_dates/table_end_date'))

//Ascending

TestObject selectorType = new TestObject()
selectorType.addProperty('css', ConditionType.EQUALS, 'td:nth-of-type(4)')
...
//WebUI.takeScreenshot('special_dates/Sort _by end date.png')
