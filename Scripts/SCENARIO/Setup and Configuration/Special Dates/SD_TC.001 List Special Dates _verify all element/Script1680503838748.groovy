...
WebUI.verifyElementPresent(findTestObject('Object Repository/special_dates/list_tbl_name'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/special_dates/list_tbl_start_date'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/special_dates/list_tbl_end_date'), 0)
