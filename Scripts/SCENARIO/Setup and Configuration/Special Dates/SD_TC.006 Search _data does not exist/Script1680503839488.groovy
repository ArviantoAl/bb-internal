...
WebUI.setText(findTestObject('Object Repository/special_dates/field_search_sd'), 'badak')

String new_xpath = "//td[@class='dataTables_empty']"
...
WebUI.verifyTextPresent('No Special Date found', false)
